...
select u1_0.id,
       case
           ...
           when u1_3.id is not null then 3
       ...
       u1_2.psp,
       u1_3.average_rating
from joined_user u1_0
         left join joined_mentor u1_1 on u1_0.id = u1_1.id
         left join joined_student u1_2 on u1_0.id = u1_2.id
         left join joined_ta u1_3 on u1_0.id = u1_3.id